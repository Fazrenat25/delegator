...
const plans = [
  ...
  },
  {
    ...
    borderColor: 'border-emerald-500/30',
    textColor: 'text-emerald-400',
    buttonColor: 'bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500',
    features: [
      ...
      <main className="container mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full mb-6">
            ...
            <span className="text-emerald-300 text-sm font-medium">Прозрачные тарифы</span>
          </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          >
            <span
              className={`absolute top-1 w-5 h-5 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-full transition-transform shadow-lg ${
            ...
            >
              ...
              {plan.popular && (
                <>
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                    <div className="flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-full shadow-lg shadow-emerald-500/30">
              ...
              <div className="p-8">
                ...
                <Link
                  ...
                  className={`w-full py-3.5 px-6 rounded-xl font-semibold text-white transition-all duration-300 shadow-lg flex items-center justify-center gap-2 hover:shadow-xl hover:scale-[1.02] ${plan.buttonColor}`}
                >
                  {plan.cta}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-slate-700">
                  ...
                  <th className="text-center py-4 px-6 text-emerald-400 font-semibold">TEAM</th>
                  <th className="text-center py-4 px-6 text-cyan-400 font-semibold">BUSINESS</th>
                </tr>
              </thead>
              <tbody>
                {[

        ...
        <div className="grid lg:grid-cols-2 gap-0 lg:gap-8 items-center">
          ...
          <div className="hidden lg:block text-white space-y-8 pr-8">
            <Link href="/" className="flex items-center gap-4 mb-12 group">
              ...
              <span className="text-4xl font-bold bg-gradient-to-r from-white via-slate-200 to-slate-400 bg-clip-text text-transparent group-hover:from-amber-400 group-hover:via-amber-500 group-hover:to-amber-600 transition-all duration-300">Delegator</span>
            </Link>
          ...
          <div className="w-full">
            ...
            <div className="lg:hidden text-center mb-8">
              <Link href="/" className="inline-flex items-center gap-3 mb-4 group">
                ...
                <span className="text-3xl font-bold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent group-hover:from-amber-400 group-hover:via-amber-500 group-hover:to-amber-600 transition-all duration-300">Delegator</span>
              </Link>

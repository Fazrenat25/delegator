        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-800/30 border border-slate-700 rounded-2xl p-8 backdrop-blur-sm">
            <p className="text-slate-300 text-lg leading-relaxed mb-8">
              Добро пожаловать в <strong className="text-amber-500">Delegator</strong>! Эти Условия использования регулируют 
              ...
              <section>
                ...
                <div className="pl-13 space-y-4 text-slate-300">
                  <p className="leading-relaxed">
                    1.1. Регистрируясь в системе Delegator, вы подтверждаете, что ознакомились с этими 
              ...
              <section>
                ...
                <div className="pl-13">
                  <p className="text-slate-300 leading-relaxed mb-4">
                    Запрещается использовать Delegator для:
                  </p>
                  <ul className="space-y-2 text-slate-300">
                    <li className="flex items-start gap-3">
              ...
              <section>
                ...
                <div className="pl-13 space-y-4 text-slate-300">
                  ...
                  <p className="leading-relaxed">
                    ...
                    <span className="text-amber-500 ml-1">legal@delegator.com</span>
                  </p>
                </div>
              </section>
            </div>
